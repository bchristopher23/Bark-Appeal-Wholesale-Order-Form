...
class Gamajo_Template_Loader {
	 ...
	 * @type string
	 */
	protected $theme_template_directory = 'ba-wholesale-order-form'; // or 'your-plugin-templates' etc.
	 ...
	 * @type string
	 */
	protected $plugin_directory = WHOLESALE_ORDER_FORM_PLUGIN_DIR; // or plugin_dir_path( dirname( __FILE__ ) ); etc.
